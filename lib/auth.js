...
const CreateTheUser = gql`
  mutation CreateTheUser($firstName: String!, $lastName: String!, $password: String!, $slug: String!, $phoneNumber: String!, $birthDate: Date!) {
    newUserCart: createCart(
      data: {theUser: {create: {firstName: $firstName, lastName: $lastName, password: $password, phoneNumber: 10, slug: $slug, birthDate: $birthDate,userRole: {connect: {id: "clkwj8n4g5z3n0bujxk2vfqpd"}}}}}
    ) {
      theUser {
        id
        slug
        ...
        if ( isLogIn === "false" && (!user || user.length === 0)) {
          ...
          return {
            ...
            user: {
              ...
              phoneNumber: newUser.phoneNumber.slice(newUser.phoneNumber.indexOf('_') + 1),

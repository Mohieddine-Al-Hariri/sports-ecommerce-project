...
export const GoogleSignInButton = () => {
	...
	return(
		<button onClick={(e) => {e.preventDefault(); handleClick()}} className='w-full flex items-center justify-center gap-2 font-semibold h-14 px-6 max-sm:text-sm max-sm:px-2 text-xl transition-colors duration-300 bg-white border-2 border-black text-black rounded-lg focus:shadow-outline hover:bg-slate-200'>
...
export const FacebookSignInButton = () => {
	...
	return (
		<button onClick={() => signIn('facebook')} className='w-full flex items-center justify-center gap-2 font-semibold h-14 px-6 text-xl transition-colors duration-300 bg-white border-2 border-black text-black rounded-lg focus:shadow-outline hover:bg-slate-200'>

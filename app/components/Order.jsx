import { publishSubmittedOrder, removeOrder, updateOrderState } from "@/lib";
    ...
    <div className="flex fontColor gap-2 p-2 justify-between items-center border-2 borderColor border-solid rounded-lg">
      ...
      <div className="flex ">
        {order.state !== "Recieved" && order.state !== "Delivering" &&
          <button onClick={cancelOrder} className="hover:border-black border-2 border-white rounded-md px-2 ">
            <svg
              fill="currentColor"
              width="30px"
              height="30px"
